...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/jpflug-cbci-workshop-april/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>jpflug-cbci-workshop-april</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>jpflug-cbci-workshop-april</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/jpflug-cbci-workshop-april/pipeline-template-catalog.git</repositoryUrl>
              <traits>
